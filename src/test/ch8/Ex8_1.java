...
import test.ch8.ATM.ATMExcepton;
import tools.Tool;
...
public class Ex8_1 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            } catch (ATM.ATMExcepton ex) {
                int errCode = ex.getErrCode();
                System.out.println("國泰世華銀行提醒您==>");
                switch (errCode) {
                    case ATMExcepton.WITH_DRAW_ERROR_1:
                        System.out.println("提款金額不能小於等於0");
                        break;
                    case ATMExcepton.WITH_DRAW_ERROR_2:
                        System.out.println("餘額不足");
                        break;
                    case ATMExcepton.DEPOSIT_ERROR_1:
                        System.out.println("存款金額不能小於等於0");
                        break;
                }
            } finally {
                System.out.println("國泰世華銀行ATM");
